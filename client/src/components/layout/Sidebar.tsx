        ...
        <div className="flex flex-col h-full pt-5 pb-4 overflow-y-auto">
          <nav className="mt-2 flex-1 px-2 space-y-1 flex flex-col h-full justify-between">
            ...
            <Link href="/">
              ...
              >
                <svg 
                  className={`mr-3 h-6 w-6 ${currentPage === 'dashboard' ? 'text-primary dark:text-white' : 'text-gray-400 dark:text-gray-400'}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24" 
            ...
            <Link href="/measurements">
              ...
              >
                <svg 
                  className={`mr-3 h-6 w-6 ${currentPage === 'measurements' ? 'text-primary dark:text-white' : 'text-gray-400 dark:text-gray-400'}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24" 
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <Link href="/statistics">
              ...
              >
                <svg 
                  className={`mr-3 h-6 w-6 ${currentPage === 'statistics' ? 'text-primary dark:text-white' : 'text-gray-400 dark:text-gray-400'}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24" 
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {(role === 'doctor' || role === 'admin') && (
              <Link href="/patients">
                ...
                >
                  <svg 
                    className={`mr-3 h-6 w-6 ${currentPage === 'patients' ? 'text-primary dark:text-white' : 'text-gray-400 dark:text-gray-400'}`} 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24" 
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <Link href="/profile">
                <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 ${
                  ...
                  <svg 
                    className={`mr-3 h-6 w-6 ${currentPage === 'profile' ? 'text-primary dark:text-white' : 'text-gray-400 dark:text-gray-400'}`} 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24" 
                    xmlns="http://www.w3.org/2000/svg"
